...
require github.com/open-telemetry/opentelemetry-collector-contrib/internal/common v0.43.0
...
require (
	...
	go.opentelemetry.io/collector/model v0.42.1-0.20220124134949-6ab3c983bbfb // indirect
